return {
	...
	simon_eliminated = "\\#ff2828\\ ¡fue eliminado por Simon!",
	...
	desc_broken_lamp = "Solo un jugador tiene la lámpara. Golpéalo para robársela. Sin ella, la oscuridad drena tu salud... Está bastante oscuro. Créditos a @RetroGames.",
	...
	select_next_minigame = "Seleccionar Próximo Minijuego",
	modifiers = "Modificadores",
	force_start_game = "Forzar Inicio del Juego",
	cancel_game = "Cancelar Juego",
	team = "Equipo",
	open_cs_menu = "Abrir Menú de CS",
	personal_settings = "Configuración Personal",
	exit_menu = "Salir del Menú",
	coopdx_menu = "Menú CoopDX",

	-- Configuración del juego
	game_mode_selection = "Selección del Modo de Juego",
	include_all_player_duel = "Incluir Duelo de Todos los Jugadores",
	total_minigames = "Total de Minijuegos",
	final_duel = "Duelo Final",
	elimination_mode = "Modo de Eliminación",
	percent_ready_to_start = "Porcentaje Listo para Empezar",
	teams = "Equipos",
	team_selection = "Selección de Equipo",
	select_teams = "Seleccionar Equipos...",

	-- Nombres de niveles
	toad_town = "Pueblo de Toad",
	koopa_keep = "Castillo Koopa",
	ds_fort = "Fuerte DS",
	duel = "Duelo",
	random = "Aleatorio",

	-- Menú de modificadores
	super_speed = "Velocidad Super",
	high_gravity = "Gravedad Alta",
	low_gravity = "Gravedad Baja",
	inverted_controls = "Controles Invertidos",
	instakill = "Muerte Instantánea",
	z_button_challenge = "Desafío del Botón Z",
	b_button_challenge = "Desafío del Botón B",

	-- Mensajes
	starting_the_game = "Comenzando el juego...",
	need_at_least_2_players = "¡Necesitas al menos 2 jugadores!",
	canceled_forced_start = "Inicio forzado cancelado.",
	are_you_sure = "¿Estás seguro? Presiona A de nuevo para continuar.",
	must_have_at_least_2_duelers = "¡Debe haber al menos 2 duelistas!",
	waiting_for_players = "Esperando a los jugadores...",
	elimination_mode_text = "Modo de Eliminación",
	last_place_eliminated = "El último lugar eliminado",
	bottom_eliminated = "Abajo ",
	eliminated_suffix = " eliminado",
	confirm_duelers = "\\#50ff50\\Confirmar Duelistas",
	all_player_duel = "\\#ffff50\\Duelo de Todos los Jugadores",
	dueler = "Duelista ",
	total_duelers = "Total de Duelistas",
	selected = "Seleccionado ",
	on = "\\#50ff50\\Activado",
	off = "\\#ff5050\\Desactivado",
	mingle_only = "Solo Mingle",
	choose = "Elegir",
	in_order = "En Orden",
	all = "Todos",
	random_teams = "Aleatorio",
	hosts_choice = "Elección del Anfitrión",
	players_choice = "Elección de los Jugadores",
	clean_install_notice = "AVISO:\nParece que NO realizaste una instalación limpia de Drench Game.\nPara reducir los tiempos de descarga, desinstala el mod y luego reinstala la última versión.",

	-- Consejos
	hint_1 = "¡Wah-hah! Wario cree que deberías golpear a tus oponentes para eliminarlos! ¡No tengas piedad!",
	hint_2 = "¡Soy yo, Mario! ¿Has visto la olla de oro? ¡Eso debe ser un montón de monedas! ¡Wowza!",
	hint_3 = "¡Soy yo, Toad! Escucha, he jugado estos juegos antes! Si tienes el modo Eliminación activo... ¡desaparecerás para siempre si eres eliminado! ¡El horror! ¡AAAAA!",
	hint_4 = "Hola, soy Luigi y estoy aquí para hablarte del Modo Selección. El anfitrión puede elegir cualquier juego que quiera jugar, incluyendo juegos Duelo 1v1. Te recomiendo ampliamente que le des una oportunidad.",
	hint_5 = '¡Wah, ese gran Toad en Luz Roja, Luz Verde es un TRAMPOSO! ¡Intentará engañarte y a veces girará MIENTRAS dice "Luz Verde"! ¡Wah, solo yo debería tener permitido hacer trampa!',
	hint_6 = "¡Toad de nuevo! Estamos peleando entre nosotros con estas monedas flotando sobre nuestras cabezas... ¡debe ser una metáfora de algo! ¡Lo sé con certeza!",
	hint_7 = "¡El juego favorito de Wario es Puente de Vidrio! ¡NO hay forma de saber qué panel de vidrio es seguro, incluso si has trabajado en una fábrica de vidrio! Siempre espero a que alguien más vaya para ver cuál es el correcto, ¡wah ha!",
	hint_8 = "¡Este mod fue una colaboración con muchas personas, demasiadas para mencionar en estos consejos! Pero la mayoría de la programación fue hecha por EmilyEmmi, quien es muy genial. Estos consejos no son parciales, por supuesto.",
	hint_9 = "¡Wah, dicen que no andar en el carrusel en Mingle es 'hacer trampa', eh? ¡Voy a lanzar a mis oponentes y meterlos en problemas! ¿Qué tal eso para hacer trampa, eh?",
	hint_10 = "¡Robo de Estrella es uno de mis favoritos! Te mueves más lentamente mientras sostienes la Súper Estrella, ¡así que necesitarás esquivar, ja-ja!",
	hint_11 = "¡Soy Toad! Odio jugar Etiqueta de Bombas... ¡siempre me golpean en el último segundo! Los jugadores que sostienen Bob-Ombs corren más rápido, ¡así que mi consejo es intentar flanquearlos! ¡Gritar también ayuda! ¡AAAAA!",
	hint_12 = 'Hola, soy Luigi y encuentro el minijuego "Rey de la Colina" como una experiencia agradable. Yo mismo estoy en contra de pelear, así que solo espero hasta que la costa esté despejada.',
	hint_13 = "¡Soy Wario! ¿Quieres aplastar a tus enemigos en Duelo o Luces Apagadas? ¡Usa el Golpe en Tierra! ¡Hace MUCHO daño si lo temporizas correctamente! Dame una parte del dinero, ¡ya que lo inventé!",
	hint_14 = "¡Todas las pistas de música excepto la de Mingle fueron creadas por murioz! Sin sus contribuciones, estarías escuchando Bob-Omb Battlefield una y otra vez...",
	hint_15 = 'Los mapas de Vestíbulo, Mingle, Puente de Vidrio y Luz Roja, Luz Verde fueron creados por biobak, ¡quien también está trabajando en el próximo hack de ROM "Regreso a la Isla de Yoshi"!',
	hint_16 = "Los mapas de Rey de la Colina, Toad Town y Koopa Keep fueron creados por Woissil con poco tiempo. La Fortaleza de Whomp se usó como mapa de depuración, y podrías caerte e perder instantáneamente... no fue divertido.",
	hint_17 = "El mapa de Duelos fue creado por mí, EmilyEmmi. Por eso es tan básico comparado con los demás...",
	hint_18 = "¡SOY TOAD Y ODIO LUCES APAGADAS! ¡Intento trepar las cadenas para escapar, pero están demasiado resbaladizas y me caigo y me hiero! ¡AUCH!",
	hint_19 = "¡Wah, estuve investigando Etiqueta de Bombas y descubrí que ESTÁ AMAÑADO! ¡Siempre le dan las Bob-Ombs a los jugadores que las han tenido el menor tiempo! ¡Deben odiar a los ganadores como yo!",
	hint_20 = "Hola jugador. ¿Has notado que algunas puertas se niegan a abrirse en Mingle? Aparentemente, hay menos puertas disponibles después de la tercera ronda. Espero que encuentres este consejo útil.",
	hint_21 = "¡Tienes que cuidarte de más que solo jugadores en Robo de Estrella! ¡Si caes en lava, también perderás la Estrella! ¡Ten cuidado!",
	hint_22 = "¡Soy Wario y voy a ganar Duelos con mi información exclusiva! Puedes obtener una curación completa si eliminas a otro jugador. ¡Es la estrategia perfecta, ya que soy el mejor luchador del lugar!",
	hint_23 = "¡Este mod te lo traen nuestros (totalmente legítimos) patrocinadores de la comunidad de YouTube de Squeex! ¡Puedes ver sus anuncios en el monitor en el vestíbulo.",
	hint_24 = "¡Estos archivos de audio solían ocupar 23.7 MB! Tomó una eternidad descargar. Después de que Squishy recortó y comprimió todo el audio, ¡este tamaño se redujo a poco más de 2.5 MB! ¡Wow...",

	-- HUD Playerlist translations
	unknown = "Desconocido",
	player_num = "Jugador ",
	players_colon = "Jugadores:",
	name_header = "Nombre",
	description_header = "Descripción",
	location_header = "Ubicación",
	ping_header = "Ping",
	game_wins_header = "Victorias de Juego\nVictorias de Minijuego",
	l_mods = "[L] Mods",
	l_players = "[L] Jugadores",
	more_suffix = " más",
	no_mods_active = "No hay mods activos",
	active_mods = "Mods Activos (",

	-- HUD Main translations
	starting_in = "Comenzando en ",
	you_survived = "\\#50ff50\\SOBREVIVISTE",
	you_died = "\\#ff2828\\MORISTE",
	no_one_won = "\\#ff2828\\Nadie ganó...",
	multiple_winners = "\\#ffff50\\¡Múltiples ganadores!",
	wins_suffix = "\\#ffff50\\ gana!",
	...
	-- Spectator messages
	entered_spectator = "\\#ffff50\\Entraste en modo espectador.",
	exited_spectator = "\\#ffff50\\Saliste del modo espectador.",
	exit_spectator_after_game = "\\#ffff50\\Saldrás del modo espectador después de este juego.",
	exit_spectator_after_round = "\\#ffff50\\Saldrás del modo espectador después de esta ronda.",
	exit_spectator_after_minigame = "\\#ffff50\\Saldrás del modo espectador después de este minijuego.",

	-- Game messages
	made_spectator = "\\#ff5050\\Fuiste convertido en espectador. Muévete de nuevo para cancelar.",
	connected = " \\#ffffff\\conectado.",
	can_rejoin = "\\#ffff50\\ puede volver a unirse para restaurar su progreso.",
	progress_restored = "\\#ffff50\\¡Tu progreso fue restaurado!",
	moderator_pick = "\\#ffff50\\¡Como eres el primer moderador disponible, elegirás este minijuego!",
	killed_player_heal = "\\#ffff50\\¡Mataste a ",
	got_full_heal = "!\\n\\#ffff50\\¡Obtuviste curación completa!",
	killed_player = "\\#ffff50\\¡Mataste a ",
	killed_suffix = "!",
	correcting_desync = "Intentando corregir desincronización...",
	ready = "¡Listo!",

	simon_jump = "¡Salta!",
	simon_attack = "¡Ataca!",
	simon_dont_move = "¡No te muevas!",
	simon_walk = "¡Camina!",
	simon_lava = "¡Quémate en la lava!",
	simon_ledge = "¡Agarra un borde!",
	simon_run = "¡Corre!",
